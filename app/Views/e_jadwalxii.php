<div class="container">
  <form action="<?= base_url('home/aksi_e_jadwalxii') ?>" method="POST">
  <table>
    <br>
    <br>
    <br>
...
<script>
    $(function() {
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" id="j" placeholder="Enter Jurusan"   name="j" value="<?= $satu->jurusan ?>">
      </div>
      ...
      <input type="hidden" name="id" value="<?= $satu->id_xii ?>">
